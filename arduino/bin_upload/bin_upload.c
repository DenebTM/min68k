/**
 * the PC component to the Arduino project
 *
 * takes three required arguments:
 * - serial port
 * - baud rate [see get_speed]
 * - binary name
 * and two optional arguments:
 * - clear [0|1]: erase SRAM before writing
 * - no_write [0|1]: write the binary or not (useful for soft-rebooting the 68k)
 */
